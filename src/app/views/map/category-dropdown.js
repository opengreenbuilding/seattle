define([
  ...
  'backbone',
  'models/city',
  'text!templates/map_controls/category-dropdown.html',
], function($, _, Backbone, CityModel, MapCategoryDropdownTemplate){
  var OTHER_LABEL = "Other";

  var MapCategoryDropdownView = Backbone.View.extend({
    ...
    render: function(){
      var fieldName = this.layer.field_name,
          ...
          template = _.template(MapCategoryDropdownTemplate);
  ...
  return MapCategoryDropdownView;
